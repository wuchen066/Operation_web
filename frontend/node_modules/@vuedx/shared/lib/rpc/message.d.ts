...
export declare type MessageID = Opaque<string, 'Message'>;
...
export declare type Message = GetMessage | SetMessage | ApplyMessage | ConstructMessage | EndpointMessage | ReleaseMessage | ReturnMessage;
export {};
