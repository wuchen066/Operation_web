...
const VISITOR_KEYS = [
    ...
    [],
    ['branches'],
    ['condition', 'userKey', 'children'],
    ['source', 'keyAlias', 'valueAlias', 'objectIndexAlias', 'children'],
    [],
    [],
    [],
    [],
...
export { ElementTypes, NodeTypes, builtInDirectives, createSimpleExpression, findParentNode, findTemplateChildNodeAt, findTemplateChildrenInRange, findTemplateNodeAt, findTemplateNodeInRange, findTemplateNodesInRange, isAttributeNode, isCommentNode, isComponentNode, isCompoundExpressionNode, isDirectiveNode, isElementNode, isExpressionNode, isInterpolationNode, isNode, isPlainElementNode, isRootNode, isSimpleExpressionNode, isSimpleIdentifier, isSlotNode, isTemplateNode, isTextNode, stringify, traverse, traverseEvery, traverseFast };
